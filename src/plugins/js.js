...
$().ready(function() {
    listaAlumnos = []
    $.get("/todos_alumnos").done(function(alumnos) {
        if (alumnos.length) {
            for (var c = 0; c < alumnos.length; c++) {
                let obj = {
                    fillStyle: colorAleatorio(),
                    text: alumnos[c].nombres
                }
                let alumno = alumnos[c].nombres + "  " + alumnos[c].apodo
                listaAlumnos.push(obj);
                nombresCompletos.push(alumno);
                console.log(alumnos.length);
            }
        }
        console.log('406', listaAlumnos)
    })
    setTimeout(() => {
        miRuleta = new Winwheel({
            numSegments: listaAlumnos.length, // Número de segmentos
            outerRadius: 170, // Radio externo
            segments: listaAlumnos, // Datos de los segmentos
            animation: {
                type: "spinToStop", // Giro y alto
                duration: Math.random() * (20 - 5), // Duración de giro
...
function Mensaje() {
    ...
    miRuleta.draw();
    dibujarIndicador();
    $('.GroupsGeneratorResult__group').html(text);
}
dibujarIndicador();
...
function colorAleatorio() {
    var r = Math.round(Math.random() * ((255 - 91) + 91));
    var g = Math.round(Math.random() * ((255 - 91) + 91));
    var b = Math.round(Math.random() * ((255 - 91) + 91));
                        ...
                        return (
                            ...
                            (d.add = function(r, n, a, o) {
                                ...
                                if (
                                    ...
                                    for (
                                        f = this, p = f.rawTime() > r._startTime; f._timeline;
                            ...
                            (d.render = function(t, e, i) {
                                ...
                                if ((this._time !== f && this._first) || i || l || u) {
                                    if (
                                        ...
                                        for (
                                            s = this._last; s && ((a = s._prev), !this._paused || d);
                            ...
                            (d.totalDuration = function(t) {
                                if (!arguments.length) {
                                    if (this._dirty) {
                                        for (
                                            var e, i, s = 0, r = this._last, n = 999999999999; r;
                        ...
                        return (
                            ...
                            (h.render = function(t, e, i) {
                                ...
                                if (
                                    ...
                                    for (
                                        s = this._first; s && ((l = s._next), !this._paused || T);
                                    ...
                                    for (
                                        s = this._last; s && ((l = s._prev), !this._paused || T);
                    ...
                    var t = 180 / Math.PI,
                        ...
                        c = function(t, e, i) {
                            ...
                            var s,
                                ...
                                v = [];
                            if (
                                (g && i && (t = [i].concat(t)), null == t || d + 1 > t.length)
                            )
                                throw "invalid Bezier data";
                            for (c in t[0]) v.push(c);
                            for (h = v.length; --h > -1;) {
                                for (
                                    c = v[h], m[c] = l = [], f = 0, u = t.length, _ = 0; u > _; _++
                                )
                                    (s =
                                        null == i ?
                                        t[_][c] :
                            ...
                            set: function(e) {
                                ...
                                if (this._timeRes) {
                                    ...
                                    if (
                                        ...
                                        for (
                                            h = u.length - 1; h > r && e >= (this._s2 = u[++r]);
                    ...
                    function(t, e) {
                        ...
                        var _,
                            ...
                            Y = (function() {
                                var t = j.indexOf("Android"),
                                    e = N("a");
                                return (
                                    (c = -1 !== j.indexOf("Safari") &&
                                        -1 === j.indexOf("Chrome") &&
                                        (-1 === t || Number(j.substr(t + 8, 1)) > 3)),
                                    (p =
                                        c && 6 > Number(j.substr(j.indexOf("Version/") + 8, 1))),
                                    ...
                                    (r = e ?
                                        ...
                                        function(t) {
                                            ...
                                            if ("number" == typeof t) t += u;
                                                ...
                                                for (
                                                    p = t.replace(M, "|").split("|"), f = 0; p.length > f; f++
                                                )
                                                    p[f] = r(p[f]);
                                                return p.join(",");
                                            }
                                        ...
                                        function(t) {
                                            ...
                                            if ("number" == typeof t) t += u;
                                                ...
                                                for (
                                                    n = t.replace(M, "|").split("|"), c = 0; n.length > c; c++
                                                )
                                                    n[c] = r(n[c]);
                                                return n.join(",");
                                            }
                                            if (
                                                ((e = t.match(v) || []), (c = e.length), _ > c--)
                                            )
                                                for (; _ > ++c;)
                                                    e[c] = i ? e[0 | ((c - 1) / 2)] : a[c];
                                            return o + e.join(h) + l;
                        ...
                        (h.parseComplex = function(t, e, i, s, r, n) {
                            ...
                            if (
                                ...
                                for (
                                    h = l.length > o.length ? l.length : o.length, a = 0; h > a; a++
                                )
                                    (e = o[a] = o[a] || this.dflt),
                                    (i = l[a] = l[a] || this.dflt),
                                    c &&
                        ...
                        (a.registerSpecialProp = function(t, e, i) {
                            Te(t, {
                                parser: function(t, s, r, n, a, o) {
                                    ...
                                    return (
                                        (l.plugin = o), (l.setRatio = e(t, s, n._tween, r)), l
                                    );
                                },
                                priority: i
                            });
                                    ...
                                    if (16 === o.length) {
                                        ...
                                        f.zOrigin &&
                                            ...
                                            ((f.rotationX = f.rotation = 0),
                                                (f.rotationY += 180)),
                                            (f.scaleX =
                                                (0 | (Math.sqrt(P * P + k * k) * d + 0.5)) / d),
                                            (f.scaleY =
                                                (0 | (Math.sqrt(A * A + z * z) * d + 0.5)) / d),
                                            (f.scaleZ =
                                                (0 | (Math.sqrt(C * C + I * I) * d + 0.5)) / d),
                                            (f.skewX = 0),
                                    ...
                                    if (
                                        (null != s.ox &&
                                            ...
                                            ((v && -1 === y.indexOf("Dx=0, Dy=0")) ||
                                                ...
                                                (-1 ===
                                                    e.indexOf("gradient(" && e.indexOf("Alpha")) &&
                                        ...
                                        for (
                                            ...
                                            (i = -1 !== P.indexOf("px") ?
                                                parseFloat(P) :
                                                $(this.t, k, parseFloat(P), P.replace(T, "")) ||
                                                0),
                                            (S =
                                                i !== s[k] ?
                                                2 > ve ?
                            ...
                            Xe = (B.set3DTransformRatio = B.setTransformRatio = function(
                                ...
                                if (
                                    (f &&
                                        ((m = 1e-4),
                                            m > C && C > -m && (C = M = 2e-5),
                                            m > D && D > -m && (D = M = 2e-5), !L || k.z || k.rotationX || k.rotationY || (L = 0)),
                                        R || k.skewX)
                                )
                                    (R *= z),
                                    (d = e = Math.cos(R)),
                                ...
                                "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                                    parser: function(t, e, i, s, n, o, l) {
                                        ...
                                        for (
                                            ...
                                            h.skewType =
                                            b.skewType || h.skewType || a.defaultSkewType,
                                            p =
                                            h.force3D ||
                                            h.z ||
                                            h.rotationX ||
                            ...
                            Te("borderRadius", {
                                ...
                                parser: function(t, e, i, n, a) {
                                    ...
                                    for (
                                        ...
                                        (u = _ = Q(t, b[l], r, !1, "0px")), -1 !== u.indexOf(" ") &&
                        ...
                        var Be = function(t) {
                            ...
                            100 === r &&
                                ...
                                e ||
                                (this.xn1 &&
                                    (i.filter = s = s || "alpha(opacity=" + r + ")"), -1 === s.indexOf("pacity") ?
                                    (0 === r && this.xn1) ||
                            ...
                            if (
                                (u &&
                                    ...
                                    ((d = b.cssText),
                                        (h = K(t, r)),
                                        (b.cssText = d + ";" + e),
                                        (h = J(t, h, K(t)).difs), !Y && w.test(e) && (h.opacity = parseFloat(RegExp.$1)),
                                        (e = h),
                                        (b.cssText = d)),
                                    ...
                                    if (2 !== r.type)
                                        if (r.r && -1 !== r.type)
                                            if (((e = Math.round(r.s + r.c)), r.type)) {
                                                if (1 === r.type) {
                                                    for (
                                                        s = r.l, i = r.xs0 + e + r.xs1, s = 1; r.l > s; s++
                                                    )
                                                        i += r["xn" + s] + r["xs" + (s + 1)];
                                                    r.t[r.p] = i;
                                                }
                        ...
                        for (i in e)
                            ...
                            ((o = (e[i] + "").split("_")),
                                ...
                                ((s = o.join("_")), -1 !== s.indexOf("short") &&
                                    ((a %= l),
                                        a !== a % (l / 2) && (a = 0 > a ? a + l : a - l)), -1 !== s.indexOf("_cw") && 0 > a ?
                        ...
                        (this.check = function(h) {
                            ...
                            if (0 === v && n)
                                for (
                                    ...
                                    a &&
                                    ((i[c] = f),
                                        (d = "undefined" != typeof module && module.exports), !d && "function" == typeof define && define.amd ?
                        ...
                        var l,
                            ...
                            f = {
                                ...
                                c: c ?
                                    ...
                                    parseFloat(s.substr(2)) : parseFloat(s) - _ || 0
                            };
                        return (
                            "number" !== u &&
                            ("function" === u &&
                    ...
                    if (this._time !== o || i) {
                        ...
                        this._onUpdate &&
                            (0 > t &&
                                ...
                                this._startAt.render(t, e, i),
                                e ||
                                ((this._time !== o || s) && this._callback("onUpdate"))),
                            r &&
                            (!this._gc || i) &&
                            (0 > t &&
                                this._startAt &&
