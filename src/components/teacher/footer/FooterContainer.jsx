        ...
        <>
            <footer className="footer-distributed">
                <div className="footer-left column">
                        ...
                        ?
                            <div id="menupresentacion" className="footer-left" style={{position: "fixed",width: "10%",height: "18%",border: "solid 5px white",zIndex: 0.1}} onMouseEnter={props.toggleHoverSlide} onMouseLeave={props.toggleHoverSlide}>
