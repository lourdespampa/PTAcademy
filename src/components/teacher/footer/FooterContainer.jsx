...
>>>>>>> ebfdb65de4b8e397da928761b44df8c2311d4d72
      <div
        ...
        id="btnvideo"
        onClick={() =>
          setShow(1) + props.botonClick("btnvideo") + seturlnombre("")
        }
      >
        <img
          alt=""
        ...
        <div className="modal-general_background">
          <div className="modal-general_bg_content">
            <button
              ...
              onClick={() =>
                setShow(2) + props.botonClick("modalvideo") + setNoData(false)
              }
            >
              <img
            ...
            <div className="modal-general_container">
              <div className="modal-general_container_header">
                <span
                  className="modal-title__controlname"
                  style={{ color: "black" }}
                >
                  EMITIR VIDEO
                </span>
              ...
              <div className="modal-general_container_body">
                <input
                  ...
                  type="text"
                  name="urlvideo"
                  onChange={e => seturlnombre(e.target.value)}
                ...
                {NoData ? (
                  <p
                    style={{ color: "red" }}
                    className="mensageAction negative"
                  >
                    AGREGE UNA URL DE VIDEO
                  </p>
                ) : null}
              </div>
            </div>
    ...
    <>
      ...
      <div className="overlay" id="overlay">
        <div
          className="popup"
          id="popup"
          style={{ display: "table", background: "black" }}
        >
          <button
            id="btnCerrarDiapo"
