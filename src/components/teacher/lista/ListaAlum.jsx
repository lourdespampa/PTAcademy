    ...
    render() {
        return (
            <>
                ...
                <div id="modal-general_container" show={this.state.modals.showpuntosmas} onHide={() => this.setShow('showpuntosmas',false)}>
                    <div className="modal-general_background">
                        <div className="modal-general_bg_content">
                            <button className="modal-general_close" onClick={() => this.setShow('showpuntosmas',false)}>
                                <img className="button-zoom" src={iconExit} alt="imagen de cerrar modal" />
                            </button>
