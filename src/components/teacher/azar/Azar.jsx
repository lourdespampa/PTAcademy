...
class Azar extends React.Component {
  ...
  onClickPointAdd = async valor => {
    ...
    for (let alumno of this.state.todosAlumnos) {
      if (
        `${alumno.name_stu} ${alumno.lastName_stu}` === this.state.alumnoElegido
      ) {
        await this.setState({ point: alumno.point });
                  ...
                  <div className="modal-general_container_body">
                    <ul class="azar-tab-group">
                      <li
                        ...
                        onClick={this.handleChangePScore}
                      >
                        <p className="azar-a">POSITIVO</p>
                      </li>
                      <li
                        class={
                          this.state.tipoPuntaje
                        ...
                        onClick={this.handleChangeNScore}
                      >
                        <p className="azar-a">NEGATIVO</p>
                      </li>
                    </ul>
                    {this.state.tipoPuntaje ? (
                      <BtnPuntos
