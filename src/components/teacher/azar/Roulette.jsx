  ...
  render() {
    ...
    return (
      <div className="roulette">
        ...
        <div className="roulette-container-button">
          <input type="button" value="GIRAR" onClick={this.handleOnClick} className="button-zoom" id="btnRuleta" style={{background:"#FB9600",color:"#fff"}}/>
        </div>
      </div>
    );
  }
