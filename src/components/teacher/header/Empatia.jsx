            ...
            <header id="Empatia-header">
                ...
                <nav id="Empatia-header__menu">
                    <ul id="Empatia-header__menu-ul">
                        ...
                        <li className="Empatia-header__menu-ul-li"><Link className="nav-menu" to={`/teacher/${props.id_class}/${props.id_access}/temporizador`}>TEMPORIZADOR</Link></li>
                        <li className="Empatia-header__menu-ul-li"><Link className="nav-menu" to={`/teacher/${props.id_class}/${props.id_access}/trivia`}>TRIVIA</Link></li>
                    </ul>
                </nav>
            </header>
        </>
