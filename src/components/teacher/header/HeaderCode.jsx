  ...
  return (
    <>
      <img
        ...
        onClick={handleShow}
        width="35px"
        src={require("../../../components/../img/rueda.png")}
        alt=""
      />
      <div
...
class HeaderCode extends React.Component {
  ...
  componentDidMount(){
      console.log('navbar responsive en clase activa', this.props.id_class)
      console.log('navbar responsive en clase activa', this.props.id_access)
        ...
        <div className="Header-code__header" id="Header-code__header">
          <div className="logo">
            <img
              className="icon-img"
              height="45px"
              src={require("../../../img/index/icon.svg")}
              alt=""
            />
            <img
              className="logo-img"
              src={require("../../../img/index/logo.svg")}
              alt=""
            />
          </div>

          <div className="class-name">{this.props.nombre_clase}</div>
              ...
              <ul className="menu-header">
                <li className="menu-header__item">
                  <Link
                    ...
                    to={`/teacher/${this.props.id_class}/${this.props.id_access}`}
                  >
                    LISTA DE ALUMNOS
                  </Link>
                </li>
                <li className="menu-header__item">
                  <Link
                    onClick={this.closeMenu}
                    className="menu-header__item-link"
                    to={`/teacher/${this.props.id_class}/${this.props.id_access}/azar`}
                  >
                    AL AZAR
                  </Link>
                </li>
                <li className="menu-header__item">
                  <Link
                    onClick={this.closeMenu}
                    className="menu-header__item-link"
                    to={`/teacher/${this.props.id_class}/${this.props.id_access}/grupos`}
                  >
                    GRUPOS
                  </Link>
                </li>
          ...
          <div className="content-headercode">
            ...
            <div className="code-menu-detail">
              {localStorage.getItem("token") ? (
                <BotonSalir
                  ExitSocket={this.props.ExitSocket}
            ...
            <div
              id="modal-general_container"
              className={
                this.state.codigoModal === 0
                  ? ""
                  : this.state.codigoModal === 1
                  ? "six"
                  : this.state.codigoModal === 2
                  ? "six out"
                  : ""
              }
            >
