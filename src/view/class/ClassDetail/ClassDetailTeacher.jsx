        ...
        <div className="contenedor-Items">
          <ul className="Item-cards">
            <li className="Item-cards__item">
              <div className="Item-card">
                <div className="Item-card__content">
                  <div className="Item-card__title">Diapositivas</div>
                  <br />
            ...
            <li className="Item-cards__item">
              <div className="Item-card">
                <div className="Item-card__content">
                  <div className="Item-card__title">Formularios</div>
                  <br />
                  <div className="Item-card__text">
                    <AddForm
                      apiUrl={this.props.apiUrl}
            ...
            <li className="Item-cards__item">
              <div className="Item-card">
                <div className="Item-card__content">
                  <div className="Item-card__title">Trivia</div>
                  <br />
                  <div
                        ...
                        <div className="modal-general_container">
                          <div className="Item-card_createquestion">
                            ...
                            <input
                              type="text"
                              id="pregunta"
                              className="triviaT-input-pregunta"
                              name="question"
                              value={question}
                              onChange={this.handleChangeQuestion}
                              autoComplete="off"
                            />
                            <label className="triviaRepuestas">
                              Respuesta 1
                            </label>
                            <br />
                            <br />
                            <div className="triviaT-contenedor-respuesta custom-radios">
                              <input
                                type="text"
                                id="res1"
                                className="triviaT-input-respuestas"
                                name="answer1"
                                value={answer1}
                                onChange={this.handleChangeQuestion}
                                autoComplete="off"
                  ...
                  <div className="Item-card__textTrivia">
                    <div className="footerTriviaClass">
                      <button
                        ...
                        onClick={() => this.setShow() + this.clearAll()}
                      >
                    ...
                    <div className="triviaQuestionsBody">
                      <ul className="Questions-ListCards">
                        {this.state.preguntas.length > 0 ? (
                          ...
                          <h3 className="Questioncards-nullcards">
