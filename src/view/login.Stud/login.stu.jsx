        ...
        <Link id="link_form" to={`/loginStudent/${this.state.id_access}`}/>
              <ul className="enter-code__header">
                <li className="enter-code__academy">
                    <Link className="enter-code__academy-a" to="/">PlayTec Academy</Link>
                </li>
                <li className="enter-code__changeStudent">
                    <Link className="enter-code__academy-a" to={'/loginTeacher'}>CAMBIAR A PROFESOR</Link>
                </li>
              </ul>
              <div className="enter-code__body">
                    <div className="enter-code__formulario">
                        ...
                        <div className="col-md-6 ml-auto mr-auto text-center enter-code__body-body">
                            ...
                            <input className="input__field input__field--kozakura" value={this.state.value} onChange={this.handleChange} id="inputCode" type="text" maxLength="5" minLength="5" autoComplete="off" data-inputmask="'mask':'AAAAAA'" im-insert="true" required/>
                            ...
                            <button onClick={()=>this.ValidateCode()} className="btn btn-block btn-lg btn-info enter-code__button">INGRESAR</button>
                        </div>
                    </div>
              </div>
            </div>
