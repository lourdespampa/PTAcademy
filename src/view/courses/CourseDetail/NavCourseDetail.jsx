  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body><FormAddStudent apiUrl={props.apiUrl} getdata={props.getdata} idcourse={props.idcourse} idteacher={props.idteacher} handleClose={handleClose}/></Modal.Body>
      </Modal>
    </>
  );
}
