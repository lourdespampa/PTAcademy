          ...
          <div className="login-cuerpo">
            <Link to="/Login">
              <div className="login-izquierda">
                <img src={require('./alumno.png')} className="login-alumno" alt ='alumno'/>
            ...
            <Link to="/loginTeacher">
              <div className="login-centro">
                <img
                  src={require('./profesora.png')} className="login-teacher" alt='profesora'
                />
            ...
            <Link to="#">
              <div className="login-derecha">
                <img src={require('./house.png')} className="login-house" alt='login' />
